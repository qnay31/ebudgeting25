...
$query  = mysqli_query($conn, "SELECT * FROM input_maintenance WHERE tgl_dibuat = '$tglPengajuan' AND deskripsi = '$perencanaan' AND dana_anggaran = '$anggaran' ");
$num    = $query->num_rows;
...
if($num === 1 ) {
    ...
    $sql ="UPDATE input_maintenance SET tgl_dibuat = '$tglPengajuan', deskripsi = '$perencanaan', dana_anggaran = '$anggaran' WHERE id = '$id'";
