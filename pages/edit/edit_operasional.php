...
$query  = mysqli_query($conn, "SELECT * FROM input_operasional_yayasan WHERE tgl_dibuat = '$tglPengajuan' AND deskripsi = '$perencanaan' AND dana_anggaran = '$anggaran' ");
$num    = $query->num_rows;
...
if($num === 1 ) {
    ...
    $sql ="UPDATE input_operasional_yayasan SET tgl_dibuat = '$tglPengajuan', deskripsi = '$perencanaan', dana_anggaran = '$anggaran' WHERE id = '$id'";
