...
$query  = mysqli_query($conn, "SELECT * FROM input_jasa WHERE deskripsi = '$perencanaan' ");
$num    = $query->num_rows;
...
if($num === 1 ) {
    ...
    echo "0";
    $sql ="INSERT INTO input_jasa (id_pengurus, posisi, kategori, tgl_dibuat, deskripsi, dana_anggaran, tgl_laporan, pemakaian, dana_terpakai, status, laporan, dokumen) VALUES (
        '{$dataLog[id_pengurus]}',
        '{$dataLog[posisi]}',
        '$kategori', 
        '$tglPengajuan', 
