...
$query  = mysqli_query($conn, "SELECT * FROM input_operasional_yayasan WHERE deskripsi = '$perencanaan' ");
$num    = $query->num_rows;
...
if($num === 1 ) {
    ...
    echo "0";
    $sql ="INSERT INTO input_operasional_yayasan (id_pengurus, posisi, kategori, tgl_dibuat, deskripsi, dana_anggaran, tgl_laporan, pemakaian, dana_terpakai, status, laporan, dokumen) VALUES (
        '{$dataLog[id_pengurus]}',
        '{$dataLog[posisi]}',
        '$kategori', 
        '$tglPengajuan', 
