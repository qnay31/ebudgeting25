...
$path   = '../../assets/images/laporan/paud/'; // upload directory
$dir    = '../../assets/doc/paud/';

$qExcel = mysqli_query($conn, "SELECT dokumen FROM input_paudqu WHERE dokumen = '$nameExcel'");
...
if($_FILES['image'])
{
    foreach ($_FILES['image']['name'] as $id => $val) {
        ...
        $result = mysqli_query($conn, "INSERT INTO galeri_paudqu (nomor_id, id_pengurus, program, nama, dokumentasi) VALUES (
            '$key', 
            '$id_pengurus', 
            '$pengajuan', 
            '{$dataLog[nama]}', 
...
$sql ="UPDATE input_paudqu SET tgl_pemakaian = '$tglLaporan', deskripsi_pemakaian = '$pemakaian', dana_terpakai = '$terpakai', laporan = 'Menunggu Verifikasi', dokumen = '$nameExcel' WHERE id = '$key'";
