...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jul 2025 pada 05.56
...
(1, 'manager_facebook', 'Manager Facebook', 'facebook_depok', '$2y$10$1Xsqtyw79xIEqPvy2jHjg.2F3QPVWP1Ppbp/M.U6ZMrd6hizAXChW', 'profil.png', 'Leader Media Sosial'),
(2, 'management_keuangan', 'Sahila Ilpah', 'management_keuangan', '$2y$10$xf9OC7SPCgPn4FDDqsP6/.c5H/7RzmK.BiJdhM8eOGERZP1YHLZ96', 'profil.png', 'Management Keuangan'),
(3, 'ketua_yayasan', 'Riki Subagja', 'riki1011', '$2y$10$qdAhtVahQOaW7P41Bwk.L.E/kgvAjyur9adeW9juohVZ8FNsPPwYy', '1672741532.png', 'Ketua Yayasan'),
(4, 'manager_instagram', 'Manager Instagram', 'instagram_user', '$2y$10$1Xsqtyw79xIEqPvy2jHjg.2F3QPVWP1Ppbp/M.U6ZMrd6hizAXChW', 'profil.png', 'Leader Media Sosial'),
(5, 'admin_web', 'M Rizky Amin', 'admin_web', '$2y$10$1Xsqtyw79xIEqPvy2jHjg.2F3QPVWP1Ppbp/M.U6ZMrd6hizAXChW', 'profil.png', 'Admin Website'),
(6, 'kepala_pengajuan', 'Pimpi Ayu Nuraini', 'kepala_pengajuan', '$2y$10$GyObTR09hSw5KVUoNuK4z.Mp/rtMtfsg2mT0uM50tJjcpc/HYd/nu', 'profil.png', 'Kepala Pengajuan'),
(7, 'kepala_income', 'Pimpi Ayu Nuraini', 'kepala_income', '$2y$10$xf9OC7SPCgPn4FDDqsP6/.c5H/7RzmK.BiJdhM8eOGERZP1YHLZ96', 'profil.png', 'Kepala Income'),
(8, 'sosial', 'Akun Tidak Terpakai', 'cadangan', '$2y$10$1ecQ4/jPW2ySC.ZAeynBN.d4NolGYW3dRiHcU4qzHzABdEX6NRht.', 'profil.png', 'Admin Media Sosial');
...
CREATE TABLE `asal_sekolah` (
  `id` int(11) NOT NULL,
  `nama_sekolah` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `data_income` (`id`, `bulan`, `tahun`, `income_I`, `income_II`, `income_tanpaResi`, `income_global`) VALUES
(1, 'Januari', '2025', '', '', '', ''),
(2, 'Februari', '2025', '', '', '', ''),
(3, 'Maret', '2025', '', '', '', ''),
(4, 'April', '2025', '', '', '', ''),
