...
if (
    ...
    // program
    $k = mysqli_query($connYear, "SELECT * FROM 2022_data_program");
    $skl = $k;
    ...
    // logistik
    $k2 = mysqli_query($connYear, "SELECT * FROM 2022_data_logistik");
    $skl2 = $k2;
    ...
    // uang makan
    $k3 = mysqli_query($connYear, "SELECT * FROM 2022_data_uang_makan");
    $skl3 = $k3;
    ...
    // aset yayasan
    $k4 = mysqli_query($connYear, "SELECT * FROM 2022_data_aset_yayasan");
    $skl4 = $k4;
    ...
    // anggaran lainnya
    $k5 = mysqli_query($connYear, "SELECT * FROM 2022_data_anggaran_lain");
    $skl5 = $k5;
    ...
    // gaji karyawan
    $k6 = mysqli_query($connYear, "SELECT * FROM 2022_data_gaji_karyawan");
    $skl6 = $k6;
    ...
    // paud qu
    $k7 = mysqli_query($connYear, "SELECT * FROM 2022_data_paudqu");
    $skl7 = $k7;
    ...
    // maintenance
    $k8 = mysqli_query($connYear, "SELECT * FROM 2022_data_maintenance");
    $skl8 = $k8;
    ...
    // operasional
    $k9 = mysqli_query($connYear, "SELECT * FROM 2022_data_operasional_yayasan");
    $skl9 = $k9;
    ...
    // jasa
    $k10 = mysqli_query($connYear, "SELECT * FROM 2022_data_jasa");
    $skl10 = $k10;
    ...
    $q  = mysqli_query($connYear, "SELECT * FROM 2022_data_income");
    while ($dP = $q->fetch_array()) {
        ...
        $iFacebook  = $hasil_ia+$hasil_ibogor;
    }
    ...
    $qTahun  = mysqli_query($connYear, "SELECT * FROM income_media WHERE nomor_id = '$dataLog[id]' AND status = 'OK' ");
